...
namespace ConsoleAppTelegramMimiGamesBot
{
    internal class BotMessageManager
    {
        ...
        /*
        public async static Task DeleteLastMessage(long chatId)
        {
            await _sender.botClient.DeleteMessageAsync(
                chatId: chatId,
                messageId: _sender.update.Message.MessageId - 1,
                cancellationToken: _sender.cancellationToken);
        }*/
        /*
        public async static Task RemoveReplyKeyboard(long chatId, string sendText, InlineKeyboardMarkup inlineKeyboard)
        {
